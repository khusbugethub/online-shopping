<%-- 
    Document   : npbookingsummary
    Created on : 4 Jul, 2021, 7:31:33 PM
    Author     : Admin
--%>

<%@ page import="java.util.*" %>
<jsp:useBean id="npb" scope="session" class="caacomp.NPList" />
...
<html>
<head>
<title>NewsPaper-Booking Contents </title>
<script language="javascript"> 
    function checkForEmpty()
{
    d = document.npbookcon.dop.value;
    msg = document.npbookcon.msg.value;
    cnum = document.npbookcon.cardnum.value;
...
function validDate()
{
    ...
    datefield = document.npbookcon.dop.value;
         if(datefield=="")
         {
...
function checkCardNum()
{
        var retval = true;
        var i;
        var cno = document.npbookcon.cardnum.value;
        cn = '0123456789';
                ...
                if(cn.indexOf(cno.charAt(i),0) == -1)
                    {
                        ...
                        document.npbookcon.cardnum.value="";
                        return false;
                    }
            }
...
<a href="npbooking1.jsp">Back to NP Selection </a>    
    <hr> 
<center>     
<%!
...
<th>Remove</th>
	...
	while(e.hasMoreElements())
	{
		tmpItem = (String[])e.nextElement();
                ...
                String s5 = tmpItem[6];
	%>
        <form name="remlist" action="npbookingsummary.jsp" method="get"> 
	<tr>
	<td><%= tmpItem[1] %> </td>
	<td align = "center">
            <% 
...
<br>
<form name="npbookcon" action = "npbookingprocess1.jsp" method="get" onsubmit="return checkForEmpty()"> 
<table border=2>
